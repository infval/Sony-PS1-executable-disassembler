...
SPECIAL(syscall, Special,       014)
SPECIAL(break,   Special,       015)
SPECIAL(mfhi,    MoveFromHILO,  020)
SPECIAL(mthi,    MoveToHILO,    021)
SPECIAL(mflo,    MoveFromHILO,  022)
SPECIAL(mtlo,    MoveToHILO,    023)
